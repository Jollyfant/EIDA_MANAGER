...
Database.prototype.writeSubmittedFiles = function(id, XMLDocuments, callback) {
  ...
  (next = function() {
    ...
    this.files().findOne({"sha256": metadata.sha256, "status": {"$ne": this.METADATA_STATUS_SUPERSEDED}}, function(error, document) {
...
Database.prototype.getSeedlinkServers = function(id, callback) {
  ...
  this.seedlink().find({"userId": id}).toArray(callback);
