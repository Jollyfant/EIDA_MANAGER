...
generateProfile = function(session) {
  ...
  return [
    ...
    "          <small>Your EIDA Data Center connects with the following IP address: <b>" + CONFIG.EXTERNAL.IP + ".</b></small>",
    "        </div>",
    "      </div>",
    "    </div>",
    "  </body>",
...
generateFooter = function() {
  ...
  return [
    ...
    "  <hr>",
    "  <span class='text-danger'>E</span>IDA Manager &copy; <a href='https://orfeus-eu.org'>ODC</a> " + new Date().getFullYear() + ". All Rights Reserved.",
