...
function generateAdmin(session) {
  ...
  return [
    ...
    "              <div class='card'>",
    "                <div class='card-body'>",
    "                  <h5 class='card-title'>Update Inventory Database</h5>",
    "                  <p class='card-text'>Call to update the SeisComP3 inventory database and restart FDSNWS Station.</p>",
    "                  <a href='/rpc/database' class='btn btn-success btn-sm'><span class='fas fa-cogs' aria-hidden='true'></span> Update Inventory </a>",
    "                </div>",
    "              </div>",
    "            </div>",
    "          </div>",
    ...
    "                <option value='user' selected>Network Operator</option>",
...
function generateWelcomeInformation(session) {
  ...
  return [
    ...
    "        </div>",
    "        <h3>",
    "          <span class='fa fa-user-" + (session.role === "admin" ? "circle text-danger" : "circle") + "' aria-hidden='true'></span> " + session.username,
    "        </h3>",
    "      </div>",
  ].join("\n");
