...
function generateProfile(session) {
  ...
  return [
    ...
    "                  <button class='btn btn-link' onClick='downloadAsKML()'><span class='fa fa-sign-out' aria-hidden='true'></span> <small>Download KML</small></button>",
    "                </div>",
    ...
    "            <div class='card-header'>",
    "              <div style='float: right;'>",
    "                <button class='btn btn-link' onClick='downloadAsJSON()'><span class='fa fa-sign-out' aria-hidden='true'></span> <small>Download JSON</small></button>",
    "                &nbsp;",
    "                <button class='btn btn-link' onClick='downloadAsCSV()'><span class='fa fa-sign-out' aria-hidden='true'></span> <small>Download CSV</small></button>",
    "              </div>",
    ...
    "              <input id='make-restricted' name='restricted' class='form-check-input' type='checkbox'> Make restricted",
    "            </label>",
    "          </form>",
...
function generateWelcome(session) {
  ...
  return [
    "    <script>const USER_NETWORK = '" + session.network + "';</script>",
    "    <div class='container'>",
    "      <div style='text-align: center;'>",
...
function generateStationDetails(session) {
  ...
  return [
    ...
    "          </div>",
    "          <div class='col'>",
    "            <h4><span id='channel-information-header'></span> <small>Channel Information</small></h4>",
    "            <hr>",
    ...
    "                <span class='fa fa-history'></span> Metadata History for <span id='history-table-title'></span>",
    "              </button>",
    "            </h5>",
    "          </div>",
