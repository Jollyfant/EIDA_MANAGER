...
function generateAdmin(session) {
  ...
  return [
    ...
    "                  <a href='/rpc/inventory' class='btn btn-success btn-sm'><span class='fas fa-cogs' aria-hidden='true'></span> Download </a>",
    "                </div>",
    "              </div>",
    "            </div>",
    "            <div class='col-md-4'>",
