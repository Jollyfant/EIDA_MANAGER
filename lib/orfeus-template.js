...
function generateStationDetails(session) {
  ...
  return [
    ...
    "              </label>",
    "            </div>",
    "            <div class='progress' style='display: none;' id='response-loading-bar'><div class='progress-bar progress-bar-striped progress-bar-animated' role='progressbar' aria-valuenow='75' aria-valuemin='0' aria-valuemax='100'></div></div><br>",
